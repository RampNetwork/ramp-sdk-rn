...
class RampSdkModule(reactContext: ReactApplicationContext) :
    ...
    override fun onOffRampPurchaseCreated(
        ...
        sendEvent(
            reactApplicationContext,
            RampModel.Event.ON_OFFRAMP_PURCHASE_CREATED.eventName,
            RampModel.getOnOffRampPurchaseCreatedPayloadMap(
                purchase,
                purchaseViewToken,
                apiUrl,
                instanceId
    ...
    override fun offrampSendCrypto(
        ...
        sendEvent(
            ...
            RampModel.getOnOffRampSendCryptoPayloadMap(assetSymbol, amount, address, instanceId)
        )
    }
