...
export default function App() {
  ...
  const [hostApiKey, setHostApiKey] = useState(
    'ku2jt8hctex6kwjsaz6ypphp26tbjysomwuj2yfj'
  );
  const [enabledFlows, setEnabledFlows] = useState<Array<string>>([
    'ONRAMP',
    'OFFRAMP',
  ]);
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.textContainer}>
        ...
        <TextInput value={hostApiKey} onChangeText={setHostApiKey} />
      </View>
      <View style={styles.switchContainer}>
        ...
        <Switch
          ...
          onValueChange={(value) => {
            const flows = value
              ? [...enabledFlows, 'ONRAMP']
              : enabledFlows.filter((flow) => flow !== 'ONRAMP');
        ...
        <Switch
          ...
          onValueChange={(value) => {
            const flows = value
              ...
              : enabledFlows.filter((flow) => flow !== 'OFFRAMP');
            setEnabledFlows(flows);
          }}
        />
        <Text>OFFRAMP</Text>
      ...
      <View style={styles.switchContainer}>
        ...
        <Switch
          ...
          onValueChange={(value) =>
            setDefaultFlow(value ? 'ONRAMP' : 'OFFRAMP')
          }
        />
        <Text>ONRAMP</Text>
        <Switch
          ...
          onValueChange={(value) =>
            setDefaultFlow(value ? 'OFFRAMP' : 'ONRAMP')
          }
        />
        <Text>OFFRAMP</Text>
      </View>
